...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelector('#certificateBox p').textContent =
    result.score >= 4 ? `لإتمامك اختبار "${result.title}" بنجاح` : 'أعد المحاولة واحصل على 4 إجابات صحيحة لفتح الشهادة';
  if (result.score < 4) document.getElementById('certificateBox').classList.add('is-locked');
