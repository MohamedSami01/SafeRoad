/**
 * quiz.js
 * Handles answer selection feedback and navigation to the result screen
 * once the quiz's questions are completed.
 *
 * NOTE: This boilerplate handles a single rendered question (from the HTML).
 * In a real build, questions would be loaded from an array/API and
 * re-rendered per index instead of being hardcoded in the HTML.
 */
